# ashcore Express.js Integration Example

This example demonstrates how to integrate ashcore with Express.js for request integrity verification.
...
3. Include all 5 ashcore headers in the request
...
ashcore errors return specific HTTP status codes:
