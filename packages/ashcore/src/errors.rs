...
// TODO(v2.0.0): Add `#[non_exhaustive]` to AshErrorCode. This would allow adding new
...
impl AshErrorCode {
    ...
    ///
    /// v2.3.5: Every error code has a unique HTTP status code for unambiguous identification.
