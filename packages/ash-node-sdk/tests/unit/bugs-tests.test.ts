...
// Message is "contextId|binding" (NOT "ASHv2.1|contextId|binding").
// The version prefix is NOT included in the HMAC message.

describe('BUG-002: derive_client_secret message format', () => {
  it('BUG-002-A: Output matches cross-SDK conformance vector', () => {
    // If the message included "ASHv2.1|" prefix, this would fail
