# ashcore Security Guide

This document provides a technical overview of ashcore's security design, assumptions, and best practices.
...
This guide focuses on how ashcore works internally and how to use it securely.

---

## Security Philosophy

ashcore is designed to protect applications from:
...
ashcore enforces request integrity and single-use validation.
...
ashcore is not a replacement for full application security.
...
|---------|---------|-----------|
| `ashcore` (Rust) | 1.0.x | Yes |
| `@3maem/ash-node-sdk` | 1.x | Yes |
...
ashcore validates whether a request was altered or replayed, not whether it is logically safe.
...
ashcore prevents replay attacks using:
...
ashcore strengthens request integrity, but secure architecture and operational practices remain essential.
